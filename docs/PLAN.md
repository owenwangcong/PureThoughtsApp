...
| **P2** | 通知 / 活动 / 日历 + 发愿 + 工具 | 🔄 进行中 | 5/11(P2.1/2.2 ⛔ 待 E3/E4/E5;P2.7 部分依赖 E6;P2.8 正念提醒 ⏸ 暂缓,入口已下架;P2.9 佛历 / P2.10 活动时区 🔄 2026-07-16 新增) | — |
...
- [ ] **P2.11** 管理員發布通知 + 首頁管理區(M,2026-07-18 用户定案「默认方案」,PRD v0.5.16 §5.3,设计 [`design/admin-notifications.md`](design/admin-notifications.md))— 首页「管理」分组(仅管理员)+ 發布通知界面(标题/内容/定时/预览确认)+ 已排程列表(取消)+ 撤回已发;RPC `admin_publish_notification`/`admin_cancel_notification`(仅 general);修复定时通知提前出现在通知中心的查询口径;檢舉處理入口迁入首页管理区。
