...
| **P1** | MVP:核心闭环(群 + 报数 + 统计)+ 上架合规 | 🔄 进行中 | 9/11(P1.1 部分完成,余 P1.10) | — |
...
- [x] **P1.11** 报数体验优化(M,2026-07-07 用户批准 7 项,PRD v0.5.3 §4.2)— 首页報數直达(单群直进/多群选择记住上次)、重複上次一键带入(取最近一天自报组合)、底部固定提交栏、替他人報數折叠(默认报自己)、常用功课置顶(最近报过去重排序,分类组剔重)、数量 ± 步进、提交随喜反馈弹层(本次摘要)。未采纳:今日已報摘要。验收 ✅ 2026-07-07:batch_utils 纯函数 4 项单测,Flutter 19/19。
